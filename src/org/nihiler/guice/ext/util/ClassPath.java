...
package org.nihiler.guice.ext.util;

import static org.nihiler.guice.ext.util.Validate.checkNotNull;
...
public final class ClassPath {
	...
	public Set<ClassInfo> getTopLevelClasses() {
		Set<ClassInfo> classInfos = new HashSet<ClassPath.ClassInfo>();
